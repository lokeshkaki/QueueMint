...
export const DYNAMODB_TABLES = {
  FAILURE_ANALYSIS: process.env['FAILURE_ANALYSIS_TABLE'] || '<table-name>-failure-analysis',
...
export const S3_BUCKETS = {
  DLQ_ANALYSIS: process.env['DLQ_ANALYSIS_BUCKET'] || '<bucket-name>',
} as const;
...
export const SSM_PARAMETERS = {
  AUTO_REPLAY_ENABLED: '/<project-name>/dlq/features/autoReplayEnabled',
  LLM_CLASSIFICATION_ENABLED: '/<project-name>/dlq/features/llmClassificationEnabled',
  PAGERDUTY_ENABLED: '/<project-name>/dlq/features/pagerdutyIntegrationEnabled',
  CONFIDENCE_THRESHOLD: '/<project-name>/dlq/config/confidenceThreshold',
  MAX_RETRIES: '/<project-name>/dlq/config/maxRetries',
} as const;
...
export const SECRETS = {
  ANTHROPIC_API_KEY: '<project-name>/anthropic-api-key',
